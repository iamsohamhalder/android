...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class ComposeThemeLibraryAccessors extends SubDependencyFactory {
        private final ComposeThemeAdapterLibraryAccessors laccForComposeThemeAdapterLibraryAccessors = new ComposeThemeAdapterLibraryAccessors(owner);

        public ComposeThemeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>compose.theme.adapter</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public ComposeThemeAdapterLibraryAccessors getAdapter() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForComposeThemeAdapterLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class ComposeThemeAdapterLibraryAccessors extends SubDependencyFactory {

        public ComposeThemeAdapterLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>x</b> with <b>com.google.android.material:compose-theme-adapter-3</b> coordinates and
         * with version reference <b>composeThemeAdapterX</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getX() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("compose.theme.adapter.x");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>composeThemeAdapterX</b> with value <b>1.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getComposeThemeAdapterX() { return getVersion("composeThemeAdapterX"); }
        ...
        /**
         * Version alias <b>daggerCompiler</b> with value <b>2.55</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>hiltVersion</b> with value <b>2.55</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>kspVersion</b> with value <b>2.1.0-1.0.29</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>serializationVersion</b> with value <b>2.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class KotlinPluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>kotlin.hilt</b> with plugin id <b>com.google.dagger:hilt-android-gradle-plugin</b> and
         * with version reference <b>hiltVersion</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getHilt() { return createPlugin("kotlin.hilt"); }
